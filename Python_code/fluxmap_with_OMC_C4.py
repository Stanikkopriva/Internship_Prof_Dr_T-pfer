...
fluxdata_df = pd.read_csv("./Csv_files/C4_Flux_Solution.csv")
...
print(flux_df)
flux_df.to_excel(r'./Excel_files/Flux_C4.xlsx', index=False)
...
def b_g(cmap=colormap, low=0, high=0, dataframe = flux_df):
    ...
    fig.savefig("./SVG_files/OMC_Colorbar_C4.svg", format='svg', bbox_inches = 'tight')
